            ...
            child: Column(
              children: [
                SizedBox(
                    ...
                    child: networkImage(
                        imageUrl:
                            "http://172.17.32.1:8080/api/v1/image/${product.imageUrl}")),
                const SizedBox(
                  height: 5,
                ),
                Text(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: colors.whiteColor, borderRadius: BorderRadius.circular(15)),
        child: Row(
          children: [
            ClipRRect(
                ...
                SizedBox(
                  ...
                  child: Text(
                    ...
                    style: textStyle.bodyNormal.copyWith(
                        fontWeight: FontWeight.bold, color: colors.blackColor),
...
class DuplicateTemplate extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    //TODO: at MyCart comeback to ProductDetail counter Cart not updated yet!
    return Scaffold(
      appBar: AppBar(
      ...
      child: Theme(
        ...
        child: Form(
          ...
          child: TextFormField(
              ...
              validator: (value) {
                if (value!.isEmpty) {
                  return "Please input for this field!";
                } else if (value.length < 5) {
                  return "This field must longer than 5 characters";
                } else {
                  return null;
                }
              },
